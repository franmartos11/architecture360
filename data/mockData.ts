...
const units: Unit[] = [
  // Building A — Floor 1
  { id: 'A01-01', name: 'A01-01', modelName: 'SUITE GARDEN', buildingId: 'torre-a', floorId: 'mock-floor', floor: 1, type: '1 dormitorio', totalArea: 68, innerArea: 58, balconyArea: 10, externalArea: 0, bedrooms: 1, bathrooms: 1, hasServiceRoom: false, status: 'available', interiorImageUrl: '/units/interior-1.jpg',
  ...
  { id: 'A01-02', name: 'A01-02', modelName: 'DUET GARDEN', buildingId: 'torre-a', floorId: 'mock-floor', floor: 1, type: '2 dormitorios', totalArea: 96, innerArea: 82, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'reserved', interiorImageUrl: '/units/interior-1.jpg', polygon: torreA01Polygons['A01-02'], tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'S' },
  { id: 'A01-03', name: 'A01-03', modelName: 'TRIO PLUS', buildingId: 'torre-a', floorId: 'mock-floor', floor: 1, type: '3 dormitorios', totalArea: 132, innerArea: 115, balconyArea: 17, externalArea: 0, bedrooms: 3, bathrooms: 2.5, hasServiceRoom: true, status: 'sold', interiorImageUrl: '/units/interior-1.jpg', polygon: torreA01Polygons['A01-03'], tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'E' },
  { id: 'A01-04', name: 'A01-04', modelName: 'SUITE CORNER', buildingId: 'torre-a', floorId: 'mock-floor', floor: 1, type: '1 dormitorio', totalArea: 72, innerArea: 62, balconyArea: 10, externalArea: 0, bedrooms: 1, bathrooms: 1, hasServiceRoom: false, status: 'available', interiorImageUrl: '/units/interior-1.jpg', polygon: torreA01Polygons['A01-04'], tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'O' },
  { id: 'A01-05', name: 'A01-05', modelName: 'DUET JARDIN', buildingId: 'torre-a', floorId: 'mock-floor', floor: 1, type: '2 dormitorios', totalArea: 106, innerArea: 89, balconyArea: 7.45, externalArea: 18.99, bedrooms: 2, bathrooms: 2.5, hasServiceRoom: true, status: 'available', interiorImageUrl: '/units/interior-1.jpg', polygon: torreA01Polygons['A01-05'], tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'NE' },
  { id: 'A01-06', name: 'A01-06', modelName: 'DUET VISTA', buildingId: 'torre-a', floorId: 'mock-floor', floor: 1, type: '2 dormitorios', totalArea: 98, innerArea: 84, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'reserved', interiorImageUrl: '/units/interior-1.jpg', polygon: torreA01Polygons['A01-06'], tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'NO' },
  { id: 'A01-07', name: 'A01-07', modelName: 'MONO STUDIO', buildingId: 'torre-a', floorId: 'mock-floor', floor: 1, type: 'monoambiente', totalArea: 45, innerArea: 38, balconyArea: 7, externalArea: 0, bedrooms: 0, bathrooms: 1, hasServiceRoom: false, status: 'available', interiorImageUrl: '/units/interior-1.jpg', polygon: torreA01Polygons['A01-07'], tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'SE' },
  { id: 'A01-08', name: 'A01-08', modelName: 'DUET POOL', buildingId: 'torre-a', floorId: 'mock-floor', floor: 1, type: '2 dormitorios', totalArea: 102, innerArea: 88, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'sold', interiorImageUrl: '/units/interior-1.jpg', polygon: torreA01Polygons['A01-08'], tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'SO' },

  // Building A — Floor 2
  { id: 'A02-01', name: 'A02-01', modelName: 'SUITE GARDEN', buildingId: 'torre-a', floorId: 'mock-floor', floor: 2, type: '1 dormitorio', totalArea: 68, innerArea: 58, balconyArea: 10, externalArea: 0, bedrooms: 1, bathrooms: 1, hasServiceRoom: false, status: 'available', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'N' },
  { id: 'A02-02', name: 'A02-02', modelName: 'DUET GARDEN', buildingId: 'torre-a', floorId: 'mock-floor', floor: 2, type: '2 dormitorios', totalArea: 96, innerArea: 82, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'sold', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'S' },
  { id: 'A02-03', name: 'A02-03', modelName: 'TRIO PLUS', buildingId: 'torre-a', floorId: 'mock-floor', floor: 2, type: '3 dormitorios', totalArea: 132, innerArea: 115, balconyArea: 17, externalArea: 0, bedrooms: 3, bathrooms: 2.5, hasServiceRoom: true, status: 'available', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'E' },

  // Building B — Floor 1
  { id: 'B01-01', name: 'B01-01', modelName: 'SUITE PREMIUM', buildingId: 'torre-b', floorId: 'mock-floor', floor: 1, type: '1 dormitorio', totalArea: 70, innerArea: 60, balconyArea: 10, externalArea: 0, bedrooms: 1, bathrooms: 1, hasServiceRoom: false, status: 'available', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'O' },
  { id: 'B01-02', name: 'B01-02', modelName: 'DUET SKY', buildingId: 'torre-b', floorId: 'mock-floor', floor: 1, type: '2 dormitorios', totalArea: 110, innerArea: 94, balconyArea: 16, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: true, status: 'reserved', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'NE' },
  { id: 'B01-03', name: 'B01-03', modelName: 'PENTHOUSE VISTA', buildingId: 'torre-b', floorId: 'mock-floor', floor: 1, type: 'penthouse', totalArea: 220, innerArea: 180, balconyArea: 40, externalArea: 0, bedrooms: 3, bathrooms: 3.5, hasServiceRoom: true, status: 'available', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'NO' },

  // Building C — Floor 1
  { id: 'C01-01', name: 'C01-01', modelName: 'STUDIO GARDEN', buildingId: 'torre-c', floorId: 'mock-floor', floor: 1, type: 'monoambiente', totalArea: 42, innerArea: 36, balconyArea: 6, externalArea: 0, bedrooms: 0, bathrooms: 1, hasServiceRoom: false, status: 'sold', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'SE' },
  { id: 'C01-02', name: 'C01-02', modelName: 'DUET PARK', buildingId: 'torre-c', floorId: 'mock-floor', floor: 1, type: '2 dormitorios', totalArea: 92, innerArea: 78, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'available', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'SO' },
];
...
const buildings: Building[] = [
  {
    ...
    floors: [
      { id: 'floor-0', number: 0, label: 'L', planImage: '/floorplans/floor-1-render.png', unitDots: [] },
      { id: 'floor-1', number: 1, label: 'Planta 1', planImage: '/floorplans/floor-1-render.png', unitDots: floorADots },
      { id: 'floor-2', number: 2, label: 'Planta 2', planImage: '/floorplans/floor-1-render.png', unitDots: floorA2Dots },
      { id: 'floor-3', number: 3, label: 'Planta 3', planImage: '/floorplans/floor-1-render.png', unitDots: floorADots.map(d => ({ ...d, unitId: d.unitId.replace('01', '03') })) },
  ...
  },
  {
    ...
    totalFloors: 12,
    floors: [
      { id: 'floor-b-1', number: 1, label: 'Planta 1', planImage: '/floorplans/floor-1-render.png', unitDots: [
  ...
  },
  {
    ...
    totalFloors: 10,
    floors: [
      { id: 'floor-c-1', number: 1, label: 'Planta 1', planImage: '/floorplans/floor-1-render.png', unitDots: [
