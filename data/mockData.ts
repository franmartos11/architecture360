...
const units: Unit[] = [
  // Building A — Floor 1
  { id: 'A01-01', name: 'A01-01', modelName: 'SUITE GARDEN', buildingId: 'torre-a', floor: 1, type: '1 dormitorio', totalArea: 68, innerArea: 58, balconyArea: 10, externalArea: 0, bedrooms: 1, bathrooms: 1, hasServiceRoom: false, status: 'available', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1.png', galleryImages: GALLERY },
  { id: 'A01-02', name: 'A01-02', modelName: 'DUET GARDEN', buildingId: 'torre-a', floor: 1, type: '2 dormitorios', totalArea: 96, innerArea: 82, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'reserved', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1.png', galleryImages: GALLERY },
  { id: 'A01-03', name: 'A01-03', modelName: 'TRIO PLUS', buildingId: 'torre-a', floor: 1, type: '3 dormitorios', totalArea: 132, innerArea: 115, balconyArea: 17, externalArea: 0, bedrooms: 3, bathrooms: 2.5, hasServiceRoom: true, status: 'sold', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1.png', galleryImages: GALLERY },
  ...
  { id: 'A01-06', name: 'A01-06', modelName: 'DUET VISTA', buildingId: 'torre-a', floor: 1, type: '2 dormitorios', totalArea: 98, innerArea: 84, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'reserved', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1.png', galleryImages: GALLERY },
  ...
  { id: 'A01-08', name: 'A01-08', modelName: 'DUET POOL', buildingId: 'torre-a', floor: 1, type: '2 dormitorios', totalArea: 102, innerArea: 88, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'sold', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1.png', galleryImages: GALLERY },
  ...
  { id: 'A02-02', name: 'A02-02', modelName: 'DUET GARDEN', buildingId: 'torre-a', floor: 2, type: '2 dormitorios', totalArea: 96, innerArea: 82, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'sold', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1.png', galleryImages: GALLERY },
  ...
  { id: 'B01-02', name: 'B01-02', modelName: 'DUET SKY', buildingId: 'torre-b', floor: 1, type: '2 dormitorios', totalArea: 110, innerArea: 94, balconyArea: 16, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: true, status: 'reserved', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1.png', galleryImages: GALLERY },
  ...
  // Building C — Floor 1
  { id: 'C01-01', name: 'C01-01', modelName: 'STUDIO GARDEN', buildingId: 'torre-c', floor: 1, type: 'monoambiente', totalArea: 42, innerArea: 36, balconyArea: 6, externalArea: 0, bedrooms: 0, bathrooms: 1, hasServiceRoom: false, status: 'sold', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1.png', galleryImages: GALLERY },
