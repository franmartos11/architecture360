...
const units: Unit[] = [
  ...
  { id: 'A01-06', name: 'A01-06', modelName: 'DUET VISTA', buildingId: 'torre-a', floor: 1, type: '2 dormitorios', totalArea: 98, innerArea: 84, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'reserved', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'NO' },
  ...
  { id: 'A01-08', name: 'A01-08', modelName: 'DUET POOL', buildingId: 'torre-a', floor: 1, type: '2 dormitorios', totalArea: 102, innerArea: 88, balconyArea: 14, externalArea: 0, bedrooms: 2, bathrooms: 2, hasServiceRoom: false, status: 'sold', interiorImageUrl: '/units/interior-1.jpg', tourImageUrl: '/tours/sample-pano.png', floorPlan3dUrl: '/floorplans/floor-1-render.png', plan3dUrl: '/floorplans/floor-1-3d.png', technicalPlanUrl: '/floorplans/floor-1-2d.png', galleryImages: GALLERY, orientation: 'SO' },
